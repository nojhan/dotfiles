...
hi clear
syntax reset
let g:colors_name = "base16-railscasts-noj"
...
call <sid>hi("Normal",        s:gui04, s:gui00, s:cterm04, s:cterm00, "")
...
call <sid>hi("Comment",       s:gui0B, "", s:cterm0B, "", "")
...
call <sid>hi("Repeat",       s:gui08, "", s:cterm08, "", "")
...
call <sid>hi("Typedef",      s:gui0D, "", s:cterm0D, "", "")

" nojhan's cpp
call <sid>hi("cppOperator",  s:gui0E, "", s:cterm0E, "", "none")
call <sid>hi("cppSTL",       s:gui06, "", s:cterm06, "", "none")
call <sid>hi("cppBraces",    s:gui0A, "", s:cterm0A, "", "none")
call <sid>hi("cppStatement", s:gui0A, "", s:cterm0A, "", "none")
call <sid>hi("cppStructure", s:gui0D, "", s:cterm0D, "", "none")
